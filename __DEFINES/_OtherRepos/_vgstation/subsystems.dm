...
#define SS_INIT_MOVEMENTPROCESS 	1
#define SS_INIT_UNSPECIFIED        	0
/*
	The priority we have on cpu resources
*/
#define SS_PRIORITY_MOVEMENTPROCESS  	1000
...
#define SS_WAIT_MOVEMENTPROCESS 	1 // We fire every single tick
...
#define SS_DISPLAY_MOVEMENTPROCESS 	100
